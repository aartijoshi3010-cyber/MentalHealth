# app.py - robust single-file Streamlit mental-health app (no bcrypt)
...
st.markdown("<p style='text-align:center; color:#444;'>Sign up, log moods, set habits, view charts, export CSV.</p>", unsafe_allow_html=True)
...
if choice == "Home":
    ...
    with left:
        ...
        st.markdown("### A private place to track moods, build habits and find resources.")
...
# Resources & Export sections follow...
